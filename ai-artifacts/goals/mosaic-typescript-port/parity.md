...
| `space-resolve-colour` | Invalid colour rejected | test_resolve_colour; tests/test_public_api.py test_invalid_color_does_not_save_or_start_refresh | set-color invalid | No state write; exit 1; no refresh | eligibility / exit code | tests/unit/identity.test.ts resolveColour; CLI rejection not yet wired | in-progress |
